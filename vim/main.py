...
def get_args_parser():
    ...
    # ADD: 添加GPU参數，原本因為是多GPU訓練，所以更新這個參數
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['OTHER','CIFAR', 'IMNET', 'INAT', 'INAT19'],
...
def main(args):
    ...
    # print(f"build_dataset_class {args.nb_classes}")
